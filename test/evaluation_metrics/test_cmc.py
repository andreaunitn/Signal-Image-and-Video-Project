...
class TestCMC(TestCase):
    ...
    def test_duplicate_ids(self):
        ...
        query_ids = [0, 0, 1, 1]
        gallery_ids = [0, 0, 1, 1]
        ret = cmc(distmat, query_ids = query_ids, gallery_ids = gallery_ids, topk = 4, separate_camera_set = False, single_gallery_shot = False)
    ...
    def test_duplicate_cams(self):
        ...
        ret = cmc(distmat, query_ids = query_ids, gallery_ids = gallery_ids, query_cams = query_cams, gallery_cams = gallery_cams, topk = 5, separate_camera_set = False, single_gallery_shot = False)

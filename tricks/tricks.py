...
def main(args):
    ...
    command = "python triplet_loss.py -d {} -b {} -t {} --num-instances {} -j 2 -a resnet50 --logs-dir {} --epochs {} --combine-trainval --re_ranking --evaluate --resume logs/model_best.pth.tar".format(dataset, batch_size, trick_number, k, logs_dir, epochs)
